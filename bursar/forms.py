...
from bursar.config import labelled_gateway_choices
from bursar.models import CreditCardDetail
from bursar.utils import get_or_create_order, pay_ship_save
...
class PaymentContactInfoForm(PaymentMethodForm, ContactInfoForm):
        ...
        def __init__(self, *args, **kwargs):
            ...
            if config_value('GATEWAY', 'USE_DISCOUNTS'):
            ...
            # payment_required_fields. For example, if your CUSTOM_GATEWAY requires
            # customer's city, put the following code in the listener:
            #
            #   form.payment_required_fields['CUSTOM_GATEWAY'] = ['city']
            #
        ...
        def clean_discount(self):
            ...
            if not config_value('GATEWAY', 'USE_DISCOUNTS'):
                return ''
...
class CreditPayShipForm(SimplePayShipForm):
    ...
    def __init__(self, request, paymentmodule, *args, **kwargs):
        ...
        num_years = config_value('GATEWAY', 'CC_NUM_YEARS')
    ...
    def clean(self):            
        ...
        if not self.is_valid():
            ...
            return data
        early = config_value('GATEWAY', 'AUTH_EARLY')
